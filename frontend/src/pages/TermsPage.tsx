      ...
      <section className="legal-section">
        ...
        <ol>
          ...
          <li>
            ...
            <ol type="a">
              <li>
                <strong>해지·환불 신청 방법:</strong> 서비스 내 [설정] 페이지의 "구독 해지" 버튼을 이용하거나,
                {CONTACT_EMAIL}로 이메일 문의를 통해 언제든지 해지 또는 환불을 신청할 수 있습니다.
              </li>
              <li>
                <strong>단순 해지(자동결제만 중단):</strong> 환불 없이 다음 결제부터 자동 청구를 중단하고 싶다면
                해지만 신청하면 됩니다. 이미 결제된 기간의 만료일까지는 프리미엄 기능을 계속 이용할 수 있고,
                만료일 이후 무료 플랜으로 전환됩니다.
              </li>
              <li>
                <strong>부분(일할) 환불:</strong> 해지와 별개로 환불을 요청하면, 결제일부터 환불 요청일까지
                실제 이용한 일수를 뺀 잔여 일수만큼 아래 기준으로 계산해 환불합니다.
                환불과 동시에 프리미엄 이용 권한은 즉시 종료됩니다.
                <br />
                환불 금액 = 결제 금액 × (잔여 일수 ÷ 결제주기 전체 일수), 원 단위 미만은 절사합니다.
              </li>
              <li>
                <strong>미사용 전액 환불:</strong> 정기결제 후 7일 이내이고 프리미엄 기능을 전혀 사용하지 않은
                경우에는 위 일할 계산과 무관하게 해당 회차 결제 금액을 전액 환불합니다.
              </li>
            </ol>
          </li>
          <li>
