    ...
    <div className="legal-page">
      ...
      <section className="legal-section">
        ...
        <ol>
          ...
          <li>
            <strong>정기결제(월/연) 중도 해지 및 환불 규정</strong>
            <ol type="a">
              <li>
                <strong>해지 신청 방법:</strong> 서비스 내 [설정] 페이지의 "구독 해지" 버튼을 이용하거나,
                {CONTACT_EMAIL}로 이메일 문의를 통해 언제든지 해지를 신청할 수 있습니다.
              </li>
              <li>
                <strong>해지 신청 시점:</strong> 다음 결제일 이전에 해지를 신청하면 해당 결제일부터 자동 청구가 중단됩니다.
              </li>
              <li>
                <strong>해지 후 서비스 이용 가능 기간:</strong> 해지 신청 후에도 이미 결제된 기간의 만료일까지 프리미엄 기능을 계속 이용할 수 있습니다.
                만료일 이후에는 무료 플랜으로 전환됩니다.
              </li>
              <li>
                <strong>중도 해지 시 잔여 기간 환불:</strong> 이용 개시 후 중도 해지하는 경우, 잔여 이용기간에 대한 일할 환불은 제공하지 않습니다.
                이는 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제2호에 따라 이용자가 이용을 개시한 디지털 콘텐츠 서비스에 해당하기 때문입니다.
              </li>
              <li>
                <strong>미사용 환불:</strong> 정기결제 후 7일 이내이고 프리미엄 기능을 전혀 사용하지 않은 경우에 한하여 해당 회차 결제 금액의 전액 환불을 요청할 수 있습니다.
              </li>
            </ol>
          </li>
          <li>
            1회성 이용권(30일)의 경우, 결제 후 7일 이내이고 프리미엄 기능을 사용하지 않은 경우 전액 환불을 요청할 수 있습니다.
            이용 개시 후에는 잔여 기간에 대한 환불이 제공되지 않습니다.
          </li>
          <li>
