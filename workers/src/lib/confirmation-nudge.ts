...
//
//   1) 예고(advance, dDay===effectiveConfirmationAdvanceDays): "이번 주에 결제/배송된다"는
//      사전 안내. 과거 이력과 무관하게 매번(정기구독·배송 둘 다) — 무료는 3일 전 고정, 프리미엄만
//      settings에서 바꿀 수 있다(notification-prefs.ts).
