...
4. **상품 브랜드가 불명확할 때만 보수적으로 처리**: 상품명에 제조사·브랜드로 볼 명확한 고유명이 없거나
   "병행수입", "해외구매대행", "리셀러"처럼 진위를 확인할 수 없는 경우에는 판매처명을 폴백으로 쓰고,
   판매처도 특정할 수 없으면 brand=null로 둔다.
5. **brandDomain은 brand보다 더 보수적으로**: brand를 채웠더라도 그 회사의 정확한 도메인 철자를
   확신할 수 없으면 brandDomain=null로 남겨라. 틀린 도메인보다 로고 없이 이름만 보여주는 게 낫다.
6. isOrderConfirmation=false면 brand=null, brandDomain=null.
